...
def hyperopt_train_test(hpparams):
    ...
    best_columns = [
        'f_138', 'f_11', 'f_96', 'f_200', 'f_32', 'f_76', 'f_41', 'f_83', 'f_156', 'f_131', 'f_84', 'f_182', 'f_17',
    ]
    ...
    pipeline = ExtraTreesClassifier(**params_est)
...
def f(params):
    ...
    best_params.to_csv('results/search_df_13_05_best_features_EXTRATREE_2.csv', index=False)
